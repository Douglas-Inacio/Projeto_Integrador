...
public class DAO {
    ...
    Connection con;
    String database = "Biblioteca1"; // Modificar essa linha com o nome do seu banco de dados
    String user = "root";         // Modificar essa linha com o seu nome de usuário
    String psswrd = "ceisceis123aa";   // Modificar essa linha com a sua senha de acesso ao banco
